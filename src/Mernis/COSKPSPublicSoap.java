...
public class COSKPSPublicSoap
{
    ...
    public COSKPSPublicSoap(){}

    public COSKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public COSKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        COSExtendedSoapSerializationEnvelope envelope= new COSExtendedSoapSerializationEnvelope(COSExtendedSoapSerializationEnvelope.VER11);
