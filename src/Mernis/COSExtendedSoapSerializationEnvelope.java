...
public class COSExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(COSDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new COSStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static COSDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static COSDateTimeConverter dateTimeConverter = new COSStandardDateTimeConverter();

    public COSExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public COSExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new COSMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=COSHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,COSExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=COSHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
